...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new K8SResourceApi.PodSpecAllOfVolumesInnerAllOfCephfs();
  });
  ...
  describe('PodSpecAllOfVolumesInnerAllOfCephfs', function() {
    it('should create an instance of PodSpecAllOfVolumesInnerAllOfCephfs', function() {
      // uncomment below and update the code to test PodSpecAllOfVolumesInnerAllOfCephfs
      //var instance = new K8SResourceApi.PodSpecAllOfVolumesInnerAllOfCephfs();
      //expect(instance).to.be.a(K8SResourceApi.PodSpecAllOfVolumesInnerAllOfCephfs);
    });
