...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new K8SResourceApi.PodSpecAllOfEphemeralContainersInner();
  });
  ...
  describe('PodSpecAllOfEphemeralContainersInner', function() {
    it('should create an instance of PodSpecAllOfEphemeralContainersInner', function() {
      // uncomment below and update the code to test PodSpecAllOfEphemeralContainersInner
      //var instance = new K8SResourceApi.PodSpecAllOfEphemeralContainersInner();
      //expect(instance).to.be.a(K8SResourceApi.PodSpecAllOfEphemeralContainersInner);
    });
    ...
    it('should have the property targetContainerName (base name: "targetContainerName")', function() {
      // uncomment below and update the code to test the property targetContainerName
      //var instance = new K8SResourceApi.PodSpecAllOfEphemeralContainersInner();
      //expect(instance).to.be();
    });
