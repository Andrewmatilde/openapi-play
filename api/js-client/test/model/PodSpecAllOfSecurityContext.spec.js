...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new K8SResourceApi.PodSpecAllOfSecurityContext();
  });
  ...
  describe('PodSpecAllOfSecurityContext', function() {
    it('should create an instance of PodSpecAllOfSecurityContext', function() {
      // uncomment below and update the code to test PodSpecAllOfSecurityContext
      //var instance = new K8SResourceApi.PodSpecAllOfSecurityContext();
      //expect(instance).to.be.a(K8SResourceApi.PodSpecAllOfSecurityContext);
    });
    ...
    it('should have the property seLinuxChangePolicy (base name: "seLinuxChangePolicy")', function() {
      // uncomment below and update the code to test the property seLinuxChangePolicy
      //var instance = new K8SResourceApi.PodSpecAllOfSecurityContext();
      //expect(instance).to.be();
    });
    ...
    it('should have the property supplementalGroupsPolicy (base name: "supplementalGroupsPolicy")', function() {
      // uncomment below and update the code to test the property supplementalGroupsPolicy
      //var instance = new K8SResourceApi.PodSpecAllOfSecurityContext();
      //expect(instance).to.be();
    });
