...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new K8SResourceApi.PodSpecAllOfContainersInner();
  });
  ...
  describe('PodSpecAllOfContainersInner', function() {
    it('should create an instance of PodSpecAllOfContainersInner', function() {
      // uncomment below and update the code to test PodSpecAllOfContainersInner
      //var instance = new K8SResourceApi.PodSpecAllOfContainersInner();
      //expect(instance).to.be.a(K8SResourceApi.PodSpecAllOfContainersInner);
    });
