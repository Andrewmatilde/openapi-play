...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new K8SResourceApi.PodSpecAllOfVolumesInnerAllOfFlexVolume();
  });
  ...
  describe('PodSpecAllOfVolumesInnerAllOfFlexVolume', function() {
    it('should create an instance of PodSpecAllOfVolumesInnerAllOfFlexVolume', function() {
      // uncomment below and update the code to test PodSpecAllOfVolumesInnerAllOfFlexVolume
      //var instance = new K8SResourceApi.PodSpecAllOfVolumesInnerAllOfFlexVolume();
      //expect(instance).to.be.a(K8SResourceApi.PodSpecAllOfVolumesInnerAllOfFlexVolume);
    });
