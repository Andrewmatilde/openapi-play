...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new K8SResourceApi.PodSpecAllOfSecurityContextAllOfWindowsOptions();
  });
  ...
  describe('PodSpecAllOfSecurityContextAllOfWindowsOptions', function() {
    it('should create an instance of PodSpecAllOfSecurityContextAllOfWindowsOptions', function() {
      // uncomment below and update the code to test PodSpecAllOfSecurityContextAllOfWindowsOptions
      //var instance = new K8SResourceApi.PodSpecAllOfSecurityContextAllOfWindowsOptions();
      //expect(instance).to.be.a(K8SResourceApi.PodSpecAllOfSecurityContextAllOfWindowsOptions);
    });
