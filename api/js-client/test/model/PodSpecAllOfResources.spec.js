...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new K8SResourceApi.PodSpecAllOfResources();
  });
  ...
  describe('PodSpecAllOfResources', function() {
    it('should create an instance of PodSpecAllOfResources', function() {
      // uncomment below and update the code to test PodSpecAllOfResources
      //var instance = new K8SResourceApi.PodSpecAllOfResources();
      //expect(instance).to.be.a(K8SResourceApi.PodSpecAllOfResources);
    });
