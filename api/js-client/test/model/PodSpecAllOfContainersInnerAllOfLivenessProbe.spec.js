...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new K8SResourceApi.PodSpecAllOfContainersInnerAllOfLivenessProbe();
  });
  ...
  describe('PodSpecAllOfContainersInnerAllOfLivenessProbe', function() {
    it('should create an instance of PodSpecAllOfContainersInnerAllOfLivenessProbe', function() {
      // uncomment below and update the code to test PodSpecAllOfContainersInnerAllOfLivenessProbe
      //var instance = new K8SResourceApi.PodSpecAllOfContainersInnerAllOfLivenessProbe();
      //expect(instance).to.be.a(K8SResourceApi.PodSpecAllOfContainersInnerAllOfLivenessProbe);
    });
