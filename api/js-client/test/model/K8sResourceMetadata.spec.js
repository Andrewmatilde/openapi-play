...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new K8SResourceApi.K8sResourceMetadata();
  });
  ...
  describe('K8sResourceMetadata', function() {
    it('should create an instance of K8sResourceMetadata', function() {
      // uncomment below and update the code to test K8sResourceMetadata
      //var instance = new K8SResourceApi.K8sResourceMetadata();
      //expect(instance).to.be.a(K8SResourceApi.K8sResourceMetadata);
    });
