...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new K8SResourceApi.PodSpecAllOfAffinity();
  });
  ...
  describe('PodSpecAllOfAffinity', function() {
    it('should create an instance of PodSpecAllOfAffinity', function() {
      // uncomment below and update the code to test PodSpecAllOfAffinity
      //var instance = new K8SResourceApi.PodSpecAllOfAffinity();
      //expect(instance).to.be.a(K8SResourceApi.PodSpecAllOfAffinity);
    });
