...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new K8SResourceApi.PodSpecAllOfAffinityAllOfNodeAffinity();
  });
  ...
  describe('PodSpecAllOfAffinityAllOfNodeAffinity', function() {
    it('should create an instance of PodSpecAllOfAffinityAllOfNodeAffinity', function() {
      // uncomment below and update the code to test PodSpecAllOfAffinityAllOfNodeAffinity
      //var instance = new K8SResourceApi.PodSpecAllOfAffinityAllOfNodeAffinity();
      //expect(instance).to.be.a(K8SResourceApi.PodSpecAllOfAffinityAllOfNodeAffinity);
    });
