...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new K8SResourceApi.PodSpecAllOfContainersInnerAllOfResources();
  });
  ...
  describe('PodSpecAllOfContainersInnerAllOfResources', function() {
    it('should create an instance of PodSpecAllOfContainersInnerAllOfResources', function() {
      // uncomment below and update the code to test PodSpecAllOfContainersInnerAllOfResources
      //var instance = new K8SResourceApi.PodSpecAllOfContainersInnerAllOfResources();
      //expect(instance).to.be.a(K8SResourceApi.PodSpecAllOfContainersInnerAllOfResources);
    });
