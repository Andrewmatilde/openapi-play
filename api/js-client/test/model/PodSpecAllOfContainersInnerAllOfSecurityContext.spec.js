...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new K8SResourceApi.PodSpecAllOfContainersInnerAllOfSecurityContext();
  });
  ...
  describe('PodSpecAllOfContainersInnerAllOfSecurityContext', function() {
    it('should create an instance of PodSpecAllOfContainersInnerAllOfSecurityContext', function() {
      // uncomment below and update the code to test PodSpecAllOfContainersInnerAllOfSecurityContext
      //var instance = new K8SResourceApi.PodSpecAllOfContainersInnerAllOfSecurityContext();
      //expect(instance).to.be.a(K8SResourceApi.PodSpecAllOfContainersInnerAllOfSecurityContext);
    });
