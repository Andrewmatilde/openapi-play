...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new K8SResourceApi.K8sResourceMetadataAllOfManagedFieldsInner();
  });
  ...
  describe('K8sResourceMetadataAllOfManagedFieldsInner', function() {
    it('should create an instance of K8sResourceMetadataAllOfManagedFieldsInner', function() {
      // uncomment below and update the code to test K8sResourceMetadataAllOfManagedFieldsInner
      //var instance = new K8SResourceApi.K8sResourceMetadataAllOfManagedFieldsInner();
      //expect(instance).to.be.a(K8SResourceApi.K8sResourceMetadataAllOfManagedFieldsInner);
    });
