...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new K8SResourceApi.PodSpecAllOfAffinityAllOfPodAntiAffinity();
  });
  ...
  describe('PodSpecAllOfAffinityAllOfPodAntiAffinity', function() {
    it('should create an instance of PodSpecAllOfAffinityAllOfPodAntiAffinity', function() {
      // uncomment below and update the code to test PodSpecAllOfAffinityAllOfPodAntiAffinity
      //var instance = new K8SResourceApi.PodSpecAllOfAffinityAllOfPodAntiAffinity();
      //expect(instance).to.be.a(K8SResourceApi.PodSpecAllOfAffinityAllOfPodAntiAffinity);
    });
