...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new K8SResourceApi.PodSpecAllOfVolumesInnerAllOfRbd();
  });
  ...
  describe('PodSpecAllOfVolumesInnerAllOfRbd', function() {
    it('should create an instance of PodSpecAllOfVolumesInnerAllOfRbd', function() {
      // uncomment below and update the code to test PodSpecAllOfVolumesInnerAllOfRbd
      //var instance = new K8SResourceApi.PodSpecAllOfVolumesInnerAllOfRbd();
      //expect(instance).to.be.a(K8SResourceApi.PodSpecAllOfVolumesInnerAllOfRbd);
    });
