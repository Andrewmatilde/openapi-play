...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new K8SResourceApi.IngressMetadata();
  });
  ...
  describe('IngressMetadata', function() {
    it('should create an instance of IngressMetadata', function() {
      // uncomment below and update the code to test IngressMetadata
      //var instance = new K8SResourceApi.IngressMetadata();
      //expect(instance).to.be.a(K8SResourceApi.IngressMetadata);
    });
