...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new K8SResourceApi.PodSpecAllOfVolumesInner();
  });
  ...
  describe('PodSpecAllOfVolumesInner', function() {
    it('should create an instance of PodSpecAllOfVolumesInner', function() {
      // uncomment below and update the code to test PodSpecAllOfVolumesInner
      //var instance = new K8SResourceApi.PodSpecAllOfVolumesInner();
      //expect(instance).to.be.a(K8SResourceApi.PodSpecAllOfVolumesInner);
    });
