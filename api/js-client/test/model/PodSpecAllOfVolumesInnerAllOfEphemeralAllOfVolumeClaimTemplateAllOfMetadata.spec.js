...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new K8SResourceApi.PodSpecAllOfVolumesInnerAllOfEphemeralAllOfVolumeClaimTemplateAllOfMetadata();
  });
  ...
  describe('PodSpecAllOfVolumesInnerAllOfEphemeralAllOfVolumeClaimTemplateAllOfMetadata', function() {
    it('should create an instance of PodSpecAllOfVolumesInnerAllOfEphemeralAllOfVolumeClaimTemplateAllOfMetadata', function() {
      // uncomment below and update the code to test PodSpecAllOfVolumesInnerAllOfEphemeralAllOfVolumeClaimTemplateAllOfMetadata
      //var instance = new K8SResourceApi.PodSpecAllOfVolumesInnerAllOfEphemeralAllOfVolumeClaimTemplateAllOfMetadata();
      //expect(instance).to.be.a(K8SResourceApi.PodSpecAllOfVolumesInnerAllOfEphemeralAllOfVolumeClaimTemplateAllOfMetadata);
    });
