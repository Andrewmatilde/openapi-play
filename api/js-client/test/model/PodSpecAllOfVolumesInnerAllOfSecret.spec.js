...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new K8SResourceApi.PodSpecAllOfVolumesInnerAllOfSecret();
  });
  ...
  describe('PodSpecAllOfVolumesInnerAllOfSecret', function() {
    it('should create an instance of PodSpecAllOfVolumesInnerAllOfSecret', function() {
      // uncomment below and update the code to test PodSpecAllOfVolumesInnerAllOfSecret
      //var instance = new K8SResourceApi.PodSpecAllOfVolumesInnerAllOfSecret();
      //expect(instance).to.be.a(K8SResourceApi.PodSpecAllOfVolumesInnerAllOfSecret);
    });
