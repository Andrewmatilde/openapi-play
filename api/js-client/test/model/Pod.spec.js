...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new K8SResourceApi.Pod();
  });
  ...
  describe('Pod', function() {
    it('should create an instance of Pod', function() {
      // uncomment below and update the code to test Pod
      //var instance = new K8SResourceApi.Pod();
      //expect(instance).to.be.a(K8SResourceApi.Pod);
    });
