...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new K8SResourceApi.PodSpecAllOfVolumesInnerAllOfCinder();
  });
  ...
  describe('PodSpecAllOfVolumesInnerAllOfCinder', function() {
    it('should create an instance of PodSpecAllOfVolumesInnerAllOfCinder', function() {
      // uncomment below and update the code to test PodSpecAllOfVolumesInnerAllOfCinder
      //var instance = new K8SResourceApi.PodSpecAllOfVolumesInnerAllOfCinder();
      //expect(instance).to.be.a(K8SResourceApi.PodSpecAllOfVolumesInnerAllOfCinder);
    });
