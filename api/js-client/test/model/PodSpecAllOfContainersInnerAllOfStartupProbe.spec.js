...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new K8SResourceApi.PodSpecAllOfContainersInnerAllOfStartupProbe();
  });
  ...
  describe('PodSpecAllOfContainersInnerAllOfStartupProbe', function() {
    it('should create an instance of PodSpecAllOfContainersInnerAllOfStartupProbe', function() {
      // uncomment below and update the code to test PodSpecAllOfContainersInnerAllOfStartupProbe
      //var instance = new K8SResourceApi.PodSpecAllOfContainersInnerAllOfStartupProbe();
      //expect(instance).to.be.a(K8SResourceApi.PodSpecAllOfContainersInnerAllOfStartupProbe);
    });
