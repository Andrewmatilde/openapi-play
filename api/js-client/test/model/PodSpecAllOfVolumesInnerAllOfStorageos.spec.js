...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new K8SResourceApi.PodSpecAllOfVolumesInnerAllOfStorageos();
  });
  ...
  describe('PodSpecAllOfVolumesInnerAllOfStorageos', function() {
    it('should create an instance of PodSpecAllOfVolumesInnerAllOfStorageos', function() {
      // uncomment below and update the code to test PodSpecAllOfVolumesInnerAllOfStorageos
      //var instance = new K8SResourceApi.PodSpecAllOfVolumesInnerAllOfStorageos();
      //expect(instance).to.be.a(K8SResourceApi.PodSpecAllOfVolumesInnerAllOfStorageos);
    });
