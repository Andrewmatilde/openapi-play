...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new K8SResourceApi.PodSpecAllOfResourceClaimsInner();
  });
  ...
  describe('PodSpecAllOfResourceClaimsInner', function() {
    it('should create an instance of PodSpecAllOfResourceClaimsInner', function() {
      // uncomment below and update the code to test PodSpecAllOfResourceClaimsInner
      //var instance = new K8SResourceApi.PodSpecAllOfResourceClaimsInner();
      //expect(instance).to.be.a(K8SResourceApi.PodSpecAllOfResourceClaimsInner);
    });
