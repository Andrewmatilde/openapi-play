...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new K8SResourceApi.Ingress();
  });
  ...
  describe('Ingress', function() {
    it('should create an instance of Ingress', function() {
      // uncomment below and update the code to test Ingress
      //var instance = new K8SResourceApi.Ingress();
      //expect(instance).to.be.a(K8SResourceApi.Ingress);
    });
