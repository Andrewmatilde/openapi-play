...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new K8SResourceApi.K8sResource();
  });
  ...
  describe('K8sResource', function() {
    it('should create an instance of K8sResource', function() {
      // uncomment below and update the code to test K8sResource
      //var instance = new K8SResourceApi.K8sResource();
      //expect(instance).to.be.a(K8SResourceApi.K8sResource);
    });
