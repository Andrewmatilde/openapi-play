...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new K8SResourceApi.PodSpecAllOfEphemeralContainersInnerAllOfLivenessProbe();
  });
  ...
  describe('PodSpecAllOfEphemeralContainersInnerAllOfLivenessProbe', function() {
    it('should create an instance of PodSpecAllOfEphemeralContainersInnerAllOfLivenessProbe', function() {
      // uncomment below and update the code to test PodSpecAllOfEphemeralContainersInnerAllOfLivenessProbe
      //var instance = new K8SResourceApi.PodSpecAllOfEphemeralContainersInnerAllOfLivenessProbe();
      //expect(instance).to.be.a(K8SResourceApi.PodSpecAllOfEphemeralContainersInnerAllOfLivenessProbe);
    });
