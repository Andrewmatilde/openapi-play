...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new K8SResourceApi.PodSpecAllOfAffinityAllOfPodAffinity();
  });
  ...
  describe('PodSpecAllOfAffinityAllOfPodAffinity', function() {
    it('should create an instance of PodSpecAllOfAffinityAllOfPodAffinity', function() {
      // uncomment below and update the code to test PodSpecAllOfAffinityAllOfPodAffinity
      //var instance = new K8SResourceApi.PodSpecAllOfAffinityAllOfPodAffinity();
      //expect(instance).to.be.a(K8SResourceApi.PodSpecAllOfAffinityAllOfPodAffinity);
    });
