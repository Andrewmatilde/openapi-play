...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new K8SResourceApi.PodSpecAllOfContainersInnerAllOfReadinessProbe();
  });
  ...
  describe('PodSpecAllOfContainersInnerAllOfReadinessProbe', function() {
    it('should create an instance of PodSpecAllOfContainersInnerAllOfReadinessProbe', function() {
      // uncomment below and update the code to test PodSpecAllOfContainersInnerAllOfReadinessProbe
      //var instance = new K8SResourceApi.PodSpecAllOfContainersInnerAllOfReadinessProbe();
      //expect(instance).to.be.a(K8SResourceApi.PodSpecAllOfContainersInnerAllOfReadinessProbe);
    });
