...
/**
 * The IngressMetadata model module.
 * @module model/IngressMetadata
 * @version 1.0.0
 */
class IngressMetadata {
    /**
     * Constructs a new <code>IngressMetadata</code>.
     * Standard object&#39;s metadata. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#metadata
     * @alias module:model/IngressMetadata
     */
    constructor() { 
        
        IngressMetadata.initialize(this);
    }
    ...
    /**
     * Constructs a <code>IngressMetadata</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/IngressMetadata} obj Optional instance to populate.
     * @return {module:model/IngressMetadata} The populated <code>IngressMetadata</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new IngressMetadata();
    ...
    /**
     * Validates the JSON data with respect to <code>IngressMetadata</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>IngressMetadata</code>.
     */
 ...
 */
IngressMetadata.prototype['annotations'] = undefined;

/**
 * Time is a wrapper around time.Time which supports correct marshaling to YAML and JSON.  Wrappers are provided for many of the factory methods that the time package offers.
 * @member {Date} creationTimestamp
 */
IngressMetadata.prototype['creationTimestamp'] = undefined;

/**
 * Number of seconds allowed for this object to gracefully terminate before it will be removed from the system. Only set when deletionTimestamp is also set. May only be shortened. Read-only.
 * @member {Number} deletionGracePeriodSeconds
 */
IngressMetadata.prototype['deletionGracePeriodSeconds'] = undefined;

/**
 * Time is a wrapper around time.Time which supports correct marshaling to YAML and JSON.  Wrappers are provided for many of the factory methods that the time package offers.
 * @member {Date} deletionTimestamp
 */
IngressMetadata.prototype['deletionTimestamp'] = undefined;
 ...
 */
IngressMetadata.prototype['finalizers'] = undefined;
 ...
 */
IngressMetadata.prototype['generateName'] = undefined;

/**
 * A sequence number representing a specific generation of the desired state. Populated by the system. Read-only.
 * @member {Number} generation
 */
IngressMetadata.prototype['generation'] = undefined;

/**
 * Map of string keys and values that can be used to organize and categorize (scope and select) objects. May match selectors of replication controllers and services. More info: https://kubernetes.io/docs/concepts/overview/working-with-objects/labels
 * @member {Object.<String, String>} labels
 */
IngressMetadata.prototype['labels'] = undefined;
 ...
 */
IngressMetadata.prototype['ownerReferences'] = undefined;
 ...
 */
IngressMetadata.prototype['resourceVersion'] = undefined;

/**
 * Deprecated: selfLink is a legacy read-only field that is no longer populated by the system.
 * @member {String} selfLink
 */
IngressMetadata.prototype['selfLink'] = undefined;
 ...
 * @member {String} uid
 */
IngressMetadata.prototype['uid'] = undefined;
...
export default IngressMetadata;
