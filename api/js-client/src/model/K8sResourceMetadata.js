...
import K8sResourceMetadataAllOfManagedFieldsInner from './K8sResourceMetadataAllOfManagedFieldsInner';
import K8sResourceMetadataAllOfOwnerReferencesInner from './K8sResourceMetadataAllOfOwnerReferencesInner';

/**
 * The K8sResourceMetadata model module.
 * @module model/K8sResourceMetadata
 * @version 1.0.0
 */
class K8sResourceMetadata {
    /**
     * Constructs a new <code>K8sResourceMetadata</code>.
     * Standard object&#39;s metadata. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#metadata
     * @alias module:model/K8sResourceMetadata
     */
    constructor() { 
        
        K8sResourceMetadata.initialize(this);
    }
    ...
    /**
     * Constructs a <code>K8sResourceMetadata</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/K8sResourceMetadata} obj Optional instance to populate.
     * @return {module:model/K8sResourceMetadata} The populated <code>K8sResourceMetadata</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new K8sResourceMetadata();
            ...
            if (data.hasOwnProperty('managedFields')) {
                obj['managedFields'] = ApiClient.convertToType(data['managedFields'], [K8sResourceMetadataAllOfManagedFieldsInner]);
            }
            ...
            if (data.hasOwnProperty('ownerReferences')) {
                obj['ownerReferences'] = ApiClient.convertToType(data['ownerReferences'], [K8sResourceMetadataAllOfOwnerReferencesInner]);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>K8sResourceMetadata</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>K8sResourceMetadata</code>.
     */
    static validateJSON(data) {
        ...
        if (data['managedFields']) { // data not null
            ...
            for (const item of data['managedFields']) {
                K8sResourceMetadataAllOfManagedFieldsInner.validateJSON(item);
            };
        }
        // ensure the json data is a string
        ...
        if (data['ownerReferences']) { // data not null
            ...
            for (const item of data['ownerReferences']) {
                K8sResourceMetadataAllOfOwnerReferencesInner.validateJSON(item);
            };
        }
        // ensure the json data is a string
 ...
 */
K8sResourceMetadata.prototype['annotations'] = undefined;

/**
 * Time is a wrapper around time.Time which supports correct marshaling to YAML and JSON.  Wrappers are provided for many of the factory methods that the time package offers.
 * @member {Date} creationTimestamp
 */
K8sResourceMetadata.prototype['creationTimestamp'] = undefined;

/**
 * Number of seconds allowed for this object to gracefully terminate before it will be removed from the system. Only set when deletionTimestamp is also set. May only be shortened. Read-only.
 * @member {Number} deletionGracePeriodSeconds
 */
K8sResourceMetadata.prototype['deletionGracePeriodSeconds'] = undefined;

/**
 * Time is a wrapper around time.Time which supports correct marshaling to YAML and JSON.  Wrappers are provided for many of the factory methods that the time package offers.
 * @member {Date} deletionTimestamp
 */
K8sResourceMetadata.prototype['deletionTimestamp'] = undefined;
 ...
 */
K8sResourceMetadata.prototype['finalizers'] = undefined;
 ...
 */
K8sResourceMetadata.prototype['generateName'] = undefined;

/**
 * A sequence number representing a specific generation of the desired state. Populated by the system. Read-only.
 * @member {Number} generation
 */
K8sResourceMetadata.prototype['generation'] = undefined;

/**
 * Map of string keys and values that can be used to organize and categorize (scope and select) objects. May match selectors of replication controllers and services. More info: https://kubernetes.io/docs/concepts/overview/working-with-objects/labels
 * @member {Object.<String, String>} labels
 */
K8sResourceMetadata.prototype['labels'] = undefined;

/**
 * ManagedFields maps workflow-id and version to the set of fields that are managed by that workflow. This is mostly for internal housekeeping, and users typically shouldn't need to set or understand this field. A workflow can be the user's name, a controller's name, or the name of a specific apply path like \"ci-cd\". The set of fields is always in the version that the workflow used when modifying the object.
 * @member {Array.<module:model/K8sResourceMetadataAllOfManagedFieldsInner>} managedFields
 */
K8sResourceMetadata.prototype['managedFields'] = undefined;

/**
 * Name must be unique within a namespace. Is required when creating resources, although some resources may allow a client to request the generation of an appropriate name automatically. Name is primarily intended for creation idempotence and configuration definition. Cannot be updated. More info: https://kubernetes.io/docs/concepts/overview/working-with-objects/names#names
 * @member {String} name
 */
K8sResourceMetadata.prototype['name'] = undefined;

/**
 * Namespace defines the space within which each name must be unique. An empty namespace is equivalent to the \"default\" namespace, but \"default\" is the canonical representation. Not all objects are required to be scoped to a namespace - the value of this field for those objects will be empty.  Must be a DNS_LABEL. Cannot be updated. More info: https://kubernetes.io/docs/concepts/overview/working-with-objects/namespaces
 * @member {String} namespace
 */
K8sResourceMetadata.prototype['namespace'] = undefined;

/**
 * List of objects depended by this object. If ALL objects in the list have been deleted, this object will be garbage collected. If this object is managed by a controller, then an entry in this list will point to this controller, with the controller field set to true. There cannot be more than one managing controller.
 * @member {Array.<module:model/K8sResourceMetadataAllOfOwnerReferencesInner>} ownerReferences
 */
K8sResourceMetadata.prototype['ownerReferences'] = undefined;
 ...
 */
K8sResourceMetadata.prototype['resourceVersion'] = undefined;

/**
 * Deprecated: selfLink is a legacy read-only field that is no longer populated by the system.
 * @member {String} selfLink
 */
K8sResourceMetadata.prototype['selfLink'] = undefined;
 ...
 * @member {String} uid
 */
K8sResourceMetadata.prototype['uid'] = undefined;
...
export default K8sResourceMetadata;
