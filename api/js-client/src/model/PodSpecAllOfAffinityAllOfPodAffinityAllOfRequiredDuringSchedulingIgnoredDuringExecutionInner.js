...
/**
 * The PodSpecAllOfAffinityAllOfPodAffinityAllOfRequiredDuringSchedulingIgnoredDuringExecutionInner model module.
 * @module model/PodSpecAllOfAffinityAllOfPodAffinityAllOfRequiredDuringSchedulingIgnoredDuringExecutionInner
 * @version 1.0.0
 */
class PodSpecAllOfAffinityAllOfPodAffinityAllOfRequiredDuringSchedulingIgnoredDuringExecutionInner {
    /**
     * Constructs a new <code>PodSpecAllOfAffinityAllOfPodAffinityAllOfRequiredDuringSchedulingIgnoredDuringExecutionInner</code>.
     * @alias module:model/PodSpecAllOfAffinityAllOfPodAffinityAllOfRequiredDuringSchedulingIgnoredDuringExecutionInner
    ...
    constructor(topologyKey) { 
        ...
        PodSpecAllOfAffinityAllOfPodAffinityAllOfRequiredDuringSchedulingIgnoredDuringExecutionInner.initialize(this, topologyKey);
    }
    ...
    /**
     * Constructs a <code>PodSpecAllOfAffinityAllOfPodAffinityAllOfRequiredDuringSchedulingIgnoredDuringExecutionInner</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PodSpecAllOfAffinityAllOfPodAffinityAllOfRequiredDuringSchedulingIgnoredDuringExecutionInner} obj Optional instance to populate.
     * @return {module:model/PodSpecAllOfAffinityAllOfPodAffinityAllOfRequiredDuringSchedulingIgnoredDuringExecutionInner} The populated <code>PodSpecAllOfAffinityAllOfPodAffinityAllOfRequiredDuringSchedulingIgnoredDuringExecutionInner</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PodSpecAllOfAffinityAllOfPodAffinityAllOfRequiredDuringSchedulingIgnoredDuringExecutionInner();
    ...
    /**
     * Validates the JSON data with respect to <code>PodSpecAllOfAffinityAllOfPodAffinityAllOfRequiredDuringSchedulingIgnoredDuringExecutionInner</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PodSpecAllOfAffinityAllOfPodAffinityAllOfRequiredDuringSchedulingIgnoredDuringExecutionInner</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of PodSpecAllOfAffinityAllOfPodAffinityAllOfRequiredDuringSchedulingIgnoredDuringExecutionInner.RequiredProperties) {
...
PodSpecAllOfAffinityAllOfPodAffinityAllOfRequiredDuringSchedulingIgnoredDuringExecutionInner.RequiredProperties = ["topologyKey"];
 ...
 */
PodSpecAllOfAffinityAllOfPodAffinityAllOfRequiredDuringSchedulingIgnoredDuringExecutionInner.prototype['labelSelector'] = undefined;
 ...
 */
PodSpecAllOfAffinityAllOfPodAffinityAllOfRequiredDuringSchedulingIgnoredDuringExecutionInner.prototype['matchLabelKeys'] = undefined;
 ...
 */
PodSpecAllOfAffinityAllOfPodAffinityAllOfRequiredDuringSchedulingIgnoredDuringExecutionInner.prototype['mismatchLabelKeys'] = undefined;
 ...
 */
PodSpecAllOfAffinityAllOfPodAffinityAllOfRequiredDuringSchedulingIgnoredDuringExecutionInner.prototype['namespaceSelector'] = undefined;

/**
 * namespaces specifies a static list of namespace names that the term applies to. The term is applied to the union of the namespaces listed in this field and the ones selected by namespaceSelector. null or empty namespaces list and null namespaceSelector means \"this pod's namespace\".
 * @member {Array.<String>} namespaces
 */
PodSpecAllOfAffinityAllOfPodAffinityAllOfRequiredDuringSchedulingIgnoredDuringExecutionInner.prototype['namespaces'] = undefined;
 ...
 * @default ''
 */
PodSpecAllOfAffinityAllOfPodAffinityAllOfRequiredDuringSchedulingIgnoredDuringExecutionInner.prototype['topologyKey'] = '';
...
export default PodSpecAllOfAffinityAllOfPodAffinityAllOfRequiredDuringSchedulingIgnoredDuringExecutionInner;
