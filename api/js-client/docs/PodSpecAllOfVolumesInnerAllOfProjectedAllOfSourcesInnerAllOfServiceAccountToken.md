# K8SResourceApi.PodSpecAllOfVolumesInnerAllOfProjectedAllOfSourcesInnerAllOfServiceAccountToken
...
**path** | **String** | path is the path relative to the mount point of the file to project the token into. | [default to &#39;&#39;]
